...
class AcogimientoPolicy
{
    ...
    {
        return $acogimiento->user_id === $user->id;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function create(Acogimiento $acogimiento, Acogido $acogido)
    {
        return $acogimiento->acogido_id === $acogido->id;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(Acogimiento $acogimiento, Acogido $acogido)
    {
        return $acogimiento->acogido_id === $acogido->id;
    }
